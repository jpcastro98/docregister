                            ...
                            <form class="document_register" action="{{ route('document.store') }}" method="POST"
                                ...
                                <div class="form_container">
                                    <div class="container_file">
                                        <div>
                                            <label>Nombre:</label>
                                            <input type="text" id="name" class="from_input" name="name"
                                                maxlength="60">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select name="tip_id">
                                                ...
                                                @foreach ($typesDocuments as $result)
                                                    <option value="{{ $result->tip_id }}">{{ $result->tip_nombre }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <select name="pro_id">
                                                ...
                                                @foreach ($processDocuments as $result)
                                                    <option value="{{ $result->pro_id }}">{{ $result->pro_nombre }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    @if (session('create'))
                                        ...
                                        <a href="{{ route('document.show', session('slug')) }}"> Ver documento</a>
                                    @endif
